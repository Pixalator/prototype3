    ...
    <>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        >
          ...
          >
            About <span className="gradient-text">Prototype</span> <span className="text-[#ff6584]">3.0</span>
          </motion.h2>
              ...
              <div className="flex flex-col gap-6 md:gap-10 p-6 sm:p-8 md:p-12 lg:p-16">
                ...
                >
                  ...
                  >
                    ...
                    >
                      Prototype 3.0 is GHRCEMN&apos;s premier hackathon where students come together to build innovative solutions to real-world problems in just 8 hours.
                    </motion.p>
